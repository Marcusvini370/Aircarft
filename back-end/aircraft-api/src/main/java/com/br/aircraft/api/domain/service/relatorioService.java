...
private static final long serialVersionUID = 1L;
	...
	public byte[] gerarRelatorio(String nomeRelatorio, Map<String,Object> params, ServletContext servletContext) throws Exception {
		...
		public String pdfAeronavesVendidas(HttpServletRequest request) throws Exception {
			byte[] pdf = gerarRelatorio(EnumRelatorio.VENDIDAS.getRelatorio(), new HashMap<String, Object>(),
			request.getServletContext());
			String base64Pdf = "data:application/pdf;base64," + Base64.encodeBase64String(pdf);
			return  base64Pdf;
		}
		
		public String pdfAeronavesNaoVendias(HttpServletRequest request) throws Exception {
			byte[] pdf = gerarRelatorio(EnumRelatorio.DISPONIVEIS.getRelatorio(), new HashMap<String, Object>(),
			request.getServletContext());
			String base64Pdf = "data:application/pdf;base64," + Base64.encodeBase64String(pdf);
			return  base64Pdf;
			}
		
		public String pdfAeronavesSemanal(HttpServletRequest request) throws Exception {
			byte[] pdf = gerarRelatorio(EnumRelatorio.SEMANAL.getRelatorio(), new HashMap<String, Object>(),
			request.getServletContext());
			String base64Pdf = "data:application/pdf;base64," + Base64.encodeBase64String(pdf);
			return  base64Pdf;
			}
